...
<script>
	...
	function getData() {
		let url0="<?php echo base_url('kajur/profile/getData')?>";
	...
	$('#profileForm').on('submit', function(e){
		e.preventDefault();
		const url="<?php echo base_url('kajur/profile/update')?>"
		var data ={
	...
	$('#PasswordForm').on('submit', function(e){
		e.preventDefault();
		const url2="<?php echo base_url('kajur/profile/ubahPassword')?>";
		var data ={
	...
	$('#uploadgambar').on('submit',function(e){
		e.preventDefault();
		const url3="<?php echo base_url('kajur/profile/ubahFoto')?>";
		 $.ajax({  
	         url:url3,                        
	         method:"POST",  
