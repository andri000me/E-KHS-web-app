			...
			<ul class="navbar-nav topbar-nav ml-md-auto align-items-center">
                <li class="nav-item dropdown hidden-caret" >
                    <a class="nav-link" data-toggle="dropdown" href="#" aria-expanded="false">
                    	<i class="flaticon-shapes ttp"></i>
                       
					</a>
                    <ul class="dropdown-menu notif-box animated fadeIn" aria-labelledby="notifDropdown">
						<li>
							<div class="dropdown-title">Pilih Prodi</div>
						</li>
						<?php $p=$this->db->get('prodi')->result(); ?>
               			<?php foreach ($p as $key) :?>
                            <li>
                                <a class="see-all" href="javascript:setProdi(<?=$key->kodeprodi;?>);"><?=$key->prodi; ?></a>
                            </li>
                        <?php endforeach ?>
				...
				<li class="nav-item dropdown hidden-caret">
					<a class="dropdown-toggle profile-pic" data-toggle="dropdown" href="#" aria-expanded="false">
						<div class="avatar-sm">
							<img src="<?=base_url()?>assets/images/<?=$this->session->userdata('foto');?>" alt="user" class="FotoUser avatar-img rounded-circle">
						</div>
					</a>
					<ul class="dropdown-menu dropdown-user animated fadeIn">
						<div class="dropdown-user-scroll scrollbar-outer">
							<li>
								<div class="user-box">
									<div class="avatar-lg"><img src="<?=base_url()?>assets/images/<?=$this->session->userdata('foto');?>" alt="user" class="avatar-img rounded FotoUser"></div>
									<div class="u-text">
										<h4 class="nUser"><?=$this->session->userdata('nama');?></h4>
										<p class="text-muted"><?=$this->session->userdata('lv');?></p><a href="<?=base_url()?>operator/profile" class="btn btn-xs btn-secondary btn-sm">Profile</a>
									</div>
								</div>
							</li>
							<li>
